...
DAYS = {
    ...
    5: ("День 5", "День 5: Пачка и ежедневные процессы", "Освойте корпоративный мессенджер, рабочие чаты, заявки и сервисные инструменты."),
...
def root_index() -> str:
    ...
    titles = {
        ...
        2: ("Продукты школы", "17 курсов, обучение от методистов"),
        3: ("Тема третьего дня", "Материалы в разработке"),
        4: ("Тема четвёртого дня", "Материалы в разработке"),
        5: ("Пачка и ежедневные процессы", "Пачка, чаты, заявки, автозвонок, ссылка на урок"),
...
<body>
  <main class="page">
    <section class="hero hero--cover" style="overflow: hidden; border-radius: 16px; width: 100%; height: clamp(240px, calc(100vh - 480px), 275px);">
